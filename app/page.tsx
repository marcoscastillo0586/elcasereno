        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="w-full">
            <p className="text-gray-400 text-base leading-relaxed mb-5 text-justify">
              Fundada en 2007 por José Luis Gorbeña (Padre) en Monte Caseros, Corrientes. El Casereño nació de una visión simple, "la fruta fina del Litoral merecía llegar fresca a destino", es así que empezamos transportando arándanos con 3 camiones y hoy ya somos más de 55 unidades y seguimos siendo la misma familia.
            </p>
